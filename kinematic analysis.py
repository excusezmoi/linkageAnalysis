...
t2plot6, t3plot, r3plot, t5plot, t6plot, dxplot, dyplot, explot, eyplot, evxplot, evyplot, eaxplot, eayplot = [npFullColumn() for _ in range(13)]
...
# Apply the filter to each array using map
[t2plot6, t3plot, r3plot, t5plot, t6plot, dxplot, dyplot, explot, eyplot, evxplot, evyplot, eaxplot, eayplot] = list(map(lambda arr: filterUnchangedValue(arr, 0.00001), [t2plot6, t3plot, r3plot, t5plot, t6plot, dxplot, dyplot, explot, eyplot, evxplot, evyplot, eaxplot, eayplot]))
