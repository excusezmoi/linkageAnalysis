...
def solveVelocity(rv2, rv3, rv4, rv5, rv6, tv2, tv3, tv5, tv6, wv2, w3, v3, w5, w6):

    def point3Velocity(rv2, rv3, tv2, tv3, wv2, w3, v3):
    ...
    vv3, wv3 = point3Velocity(rv2, rv3, tv2, tv3, wv2, w3, v3)

    def point56AngularVelocity(rv4, rv5, rv6, tv3, tv5, tv6, wv3, w5, w6):
    ...
    wv5, wv6 = point56AngularVelocity(rv4, rv5, rv6, tv3, tv5, tv6, wv3, w5, w6)
    return vv3, wv3, wv5, wv6

def solveAcceleration(rv2, rv3, rv4, rv5, rv6, tv2, tv3, tv5, tv6, vv3, wv2, wv3,wv5, wv6, av2, ar3, at3, a5, a6):

    def point3Acceleration(rv2, tv2, tv3, vv3, wv2, wv3, av2, ar3, at3):
    ...
    arv3, atv3 = point3Acceleration(rv2, tv2, tv3, vv3, wv2, wv3, av2, ar3, at3)
    
    def point56AngularAcceleration(rv4, rv5, rv6, tv3, tv5, tv6, wv3, wv5, wv6, a5, a6):
    ...
    av5, av6 = point56AngularAcceleration(rv4, rv5, rv6, tv3, tv5, tv6, wv3, wv5, wv6, a5, a6)
    return arv3, atv3, av5, av6
...
class Table:
    def __init__(self):
        self.table = pd.DataFrame(columns = ["theta2","Dpx","Dpy", "Epx", "Epy", "Evx", "Evy", "Eax", "Eay", "w6"])
...
def kinematic(rv1,rv2,rv4,rv5,rv6,rv7,wv2,av2):
    ...
    for step, tv2 in enumerate(inputAngles):
        ...
        vv3, wv3, wv5, wv6 = solveVelocity(rv2, rv3, rv4, rv5, rv6, tv2, tv3, tv5, tv6, wv2, w3, v3, w5, w6)
    #     print(f"Ve:({-rv4 * sym.sin(tv3) * wv3 - rv5 * sym.sin(tv5) * wv5},{rv4 * sym.cos(tv3) * wv3 + rv5 * sym.cos(tv5) * wv5})")
        arv3, atv3, av5, av6 = solveAcceleration(rv2, rv3, rv4, rv5, rv6, tv2, tv3, tv5, tv6, vv3, wv2, wv3,wv5, wv6, av2, ar3, at3, a5, a6)
...
if __name__ == "__main__":
    ...
    print(plotData.t2plot6)
    print(plotData.r3plot)
    print(table.table)